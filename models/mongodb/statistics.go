...
var icount = &monitor.Metric{
    ID:          "mongodb_request_count",
    Name:        "mongodb_request_count",
    Description: "MongoDB requests detail, partitioned by function and error.",
    Type:        "counter_vec",
    Args:        []string{ "func", "errmsg" },
}

var iduration = &monitor.Metric{
    ID:          "mongodb_request_duration",
    Name:        "mongodb_request_duration",
    Description: "The MongoDB request latencies in milliseconds.",
    Type:        "histogram_vec",
    Args:        []string{ "func" },
}
